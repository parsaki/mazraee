...
import com.example.modiriatemazraee.view.adapters.Recycle.archive.DKhorakAdapter
import com.example.modiriatemazraee.viewmodel.MainViewModel

class Khorack_Archive_Frag: Fragment() {
    ...
    override fun onCreateView(
        ...
        bind.home1TextTool.text = getText(R.string.khorak_archiv)
        bind.home1Back.setOnClickListener { requireActivity().onBackPressed() }


        bind.home1Recycle.adapter = DKhorakAdapter(model.Get_Khorak(),bind.root,model)
