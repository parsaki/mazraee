...
class Konsantre_Edit_Frag: Fragment() {
    ...
    override fun onCreateView(
        ...
        bind.home2Include.home2NamekonsntreText.setText(model.konsant1.value!!.namekonsntre.toString())
        bind.home2Include.home2NamekonsntreText.isEnabled = false
        bind.home2Include.home2Text5.text ="قیمت هر کیلو کنسانتره :" + model.konsant1.value!!.onkilo.toString()
        ...
        bind.home2Include.home2BtnApplysave.setOnClickListener {
            ...
            state =  model.Update_Konsantre(model.konsant1.value!!)
